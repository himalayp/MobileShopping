...
public class DBConfig {
	...
	public DataSource getH2DataSource() 
	{
		...
		dataSource.setUrl("jdbc:h2:tcp://localhost/~/mobiworld");
		dataSource.setUsername("himalay");
		dataSource.setPassword("himalay@123");
